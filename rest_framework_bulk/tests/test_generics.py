...
class TestBulkAPIViewSet(TestCase):
    ...
    def test_post_single(self):
        ...
        response = self.client.post(
            self.url,
            data=json.dumps({"contents": "hello world", "number": 1,}),
            content_type="application/json",
        )
    ...
    def test_put(self):
        ...
        response = self.client.put(
            ...
            data=json.dumps(
                [
                    {"contents": "foo", "number": 1, "id": obj1.pk,},
                    {"contents": "bar", "number": 2, "id": obj2.pk,},
                ]
            ),
            content_type="application/json",
        )
